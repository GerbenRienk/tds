...
<p>And if you want to know what others are viewing on this site, visit our <a href='/tds/howto/top5pages.jsp'>top 5</a>.</p>
<p>
...
<%@ include file="/includes/news.jsp" %>
	...
	<div class="secondary"> <!-- /.photo -->
		<div class="mod">
		<img src='/tds/img/StethoscopeNotebook.jpg' border='0' width='100%' />
		</div>
	</div> <!-- /.secondary -->
