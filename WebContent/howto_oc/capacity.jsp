...
<meta name="description" content="LibreClinica: setting up web-services" /> 
<meta name="keywords" content="libreclinica training conditional display status open source software clinical trials datamanagement 
non-profit academic edc web services client" /> 

<title>TrialDataSolutions: a capacity test for LibreClinica using web-services</title>
...
<p>So you've set-up a Study in LibreClinica and your sponsor is happy with the CRFs and everything, but now you are asked:
will LibreClinica perform once we have a hundred Subjects in this Study? And what if we have one thousand? Or maybe 
ten thousand? Or more?<br />
In this how-to-page we describe how you can demonstrate (exactly) how LibreClinica will behave, because we will
show step by step how you can duplicate the data for one Subject.</p>

<h3>preparing LibreClinica</h3>
...
The utility uses web-services to extract information from the LibreClinica instance and put data into it.
So what we need is a copy of the LibreClinica-instance with the Study and corresponding web-services for this instance.<br />
...
In our example the LibreClinica-instance is called <b>mosaic</b>, the corresponding web-services are <b>mosaicws</b> and the
...
<p>Once your two LibreClinica-applications are in place and running you can unzip the file with the 
...
and extracting the dataset in format <b>CDISC ODM XML 1.3 Clinical Data with LibreClinica extensions</b>.
...
<h3>the hard work</h3>
<p>So we now have LibreClinica with the Study with the Subject and the data in XML and web-services to do 
...
OCName and OCpassword are the name and password of the LibreClinica-user who is authorised to use SOAP.<br />
...
ready to be created in LibreClinica. Click <b>create Subjects in OC</b> and go for the coffee-machine, because this
...
is still running by switching to LibreClinica and looking at the Home-screen.<br />
