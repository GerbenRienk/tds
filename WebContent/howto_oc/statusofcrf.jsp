...
<title>Trial Data Solutions: using the status of the CRF in your expression</title>
...
<div id="wrap" class="group">
	...
	<div class="main">		
		...
		<div class="entry group">
			<h3>using the status of the CRF in your expression</h3>
			
			<p></p>
			
			<p>
			<img src='/tds/img/ImagesHowTo/statusofcrf/soc01.jpg' border='0'  class='photo'/><br />
			fig. 1: s
			</p>
		</div>
